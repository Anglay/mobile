...
define(function(require, exports, module) {
    ...
    require("md5");
    require("avalon");
    var backPwdModel = avalon.define("backPwdCtrl",function(vm){
        vm.errorinfo = "";
        vm.findpassword = function() {
            $("#findpasswordForm").validate({
                ...
                submitHandler: function(form) {
                    $.ajax({
                        url: apiconfig.baseapiurl+"base/register!check_code.action",
                        dataType: 'json',
                        type: 'post',
                        ...
                        error: function() {
                            vm.errorinfo = linklawsconfig.errorinfo
                        }
                    })
                }
            })
        ...
        vm.resetpassword = function() {
            $("#resetpasswordForm").validate({
                ...
                submitHandler: function(form) {
                    ...
                    $.ajax({
                        url: apiconfig.baseapiurl + "base/register!reset_password.action",
                        dataType: 'json',
                        type: 'post',
                        data: {
                            platform:3,
    ...
    $(function(){
        backPwdModel.findpassword();
        backPwdModel.resetpassword();
    });
});