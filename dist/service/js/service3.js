        ...
        vm.doAdvice = function(){
            if (vm.user_id!="") {
                if(vm.time==""){
                    ...
                    var params = "id="+vm.id+"&discription="+vm.discription+"&time="+vm.time+"&province_id="+vm.province_id+"&province_name="+vm.province_name+"&city_id="+vm.city_id+"&city_name="+vm.city_name;
